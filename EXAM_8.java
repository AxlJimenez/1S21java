...
public class EXAM_8{
	public static void main(String[] args) {
		...
		System.out.println("inserte un numero del 1 al 9 ");
		System.out.println("Se mostrara la tabla de multiplicar de acuerdo al numero que desee");
	    String tabla;
	    ...
	    case "1":
	    	...
	    	case "3":
	    	    System.out.println("La tabla del 3");
	    	...
	    	case "4":
	    	    System.out.println("La tabla del 4");
	         ...
	         case "6":
	    	    System.out.println("La tabla del 6");
	      ...
	      case "8":
	    	    System.out.println("La tabla del 8");
